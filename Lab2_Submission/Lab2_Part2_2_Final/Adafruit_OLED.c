...
*/
	...
	//
	// This is a Command, so pull D/C low
	//
	GPIOPinWrite(GPIOA2_BASE, 0x40, 0x0); 	// PIN 15: D/C
...
*/
	...
	//
	// This is Data, so pull D/C high for all 8 bits
	//
	GPIOPinWrite(GPIOA2_BASE, 0x40, 0xff); 	// PIN 15: D/C
